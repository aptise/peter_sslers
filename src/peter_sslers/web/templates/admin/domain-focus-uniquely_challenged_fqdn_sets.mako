...
<%block name="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="active">Uniquely Challenged FQDN Set</li>
    </ol>
</%block>


<%block name="page_header_col">
    <h2>Domain Focus - Uniquely Challenged FQDN Set</h2>
</%block>
    ...
    <div class="row">
        <div class="col-sm-9">
            % if UniquelyChallengedFQDNSets:
                ...
                ${admin_partials.table_UniquelyChallengedFQDNSets(UniquelyChallengedFQDNSets)}
            % else:
