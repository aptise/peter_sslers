...
COMMANDLINE_TESTS_DISABLE_WARNINGS = bool(int(os.getenv("COMMANDLINE_TESTS_DISABLE_WARNINGS", "0")))
COMMANDLINE_TESTS_DISABLE_LOGGINGS = bool(int(os.getenv("COMMANDLINE_TESTS_DISABLE_LOGGINGS", "0")))
