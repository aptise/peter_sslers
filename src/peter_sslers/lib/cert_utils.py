            ...
            try:
                with psutil.Popen(
                    ...
                    if PY3:
                        data = data.decode("utf8")
                    return data
            except errors.OpenSslError_InvalidKey as exc:  # noqa: F841
                return None
...
def _format_crypto_components(_in, fieldset=None):
    ...
    * [('O', 'Digital Signature Trust Co.'), ('CN', 'DST Root CA X3')]
    ...
    _out = "\n".join(_out).strip()
    # _out = _out.decode("utf8") if (PY3 and isinstance(_out, bytes)) else _out
    return _out
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                return "EC"
            except errors.OpenSslError_VersionTooLow as exc2:  # noqa: F841
