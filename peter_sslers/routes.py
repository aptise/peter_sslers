...
def _admin_views(config):
    ...
    config.add_route_7('admin:certificates:active_paginated', '/certificates/active/{@page}')
    ...
    config.add_route_7('admin:certificates:inactive_paginated', '/certificates/inactive/{@page}')
    config.add_route_7('admin:certificates|json', '/certificates.json')
    config.add_route_7('admin:certificates_paginated|json', '/certificates/{@page}.json')
    config.add_route_7('admin:certificates:active|json', '/certificates/active.json')
    config.add_route_7('admin:certificates:active_paginated|json', '/certificates/active/{@page}.json')
    config.add_route_7('admin:certificates:expiring|json', '/certificates/expiring.json')
    config.add_route_7('admin:certificates:expiring_paginated|json', '/certificates/expiring/{@page}.json')
    config.add_route_7('admin:certificates:inactive|json', '/certificates/inactive.json')
    config.add_route_7('admin:certificates:inactive_paginated|json', '/certificates/inactive/{@page}.json')
    ...
    config.add_route_7('admin:certificate:focus:renew:queue', '/certificate/{@id}/renew/queue')
    config.add_route_7('admin:certificate:focus:renew:queue|json', '/certificate/{@id}/renew/queue.json')
    ...
    config.add_route_7('admin:certificate_request:focus|json', '/certificate-request/{@id}.json')
    ...
    config.add_route_7('admin:certificate_request:focus:acme-flow:deactivate|json', '/certificate-request/{@id}/acme-flow/deactivate.json')
    ...
    config.add_route_7('admin:domain:focus:calendar|json', '/domain/{domain_identifier}/calendar.json')
    ...
    config.add_route_7('admin:queue_domains_paginated|json', '/queue-domains/{@page}.json')
    config.add_route_7('admin:queue_domains:all|json', '/queue-domains/all.json')
    config.add_route_7('admin:queue_domains:all_paginated|json', '/queue-domains/all/{@page}.json')
    ...
    config.add_route_7('admin:queue_renewals_paginated|json', '/queue-renewals/{@page}.json')
    ...
    config.add_route_7('admin:queue_renewals:all_paginated|json', '/queue-renewals/all/{@page}.json')
    config.add_route_7('admin:queue_renewals:active_failures', '/queue-renewals/active-failures')
    config.add_route_7('admin:queue_renewals:active_failures_paginated', '/queue-renewals/active-failures/{@page}')
    config.add_route_7('admin:queue_renewals:active_failures|json', '/queue-renewals/active-failures.json')
    config.add_route_7('admin:queue_renewals:active_failures_paginated|json', '/queue-renewals/active-failures/{@page}.json')
    ...
    config.add_route_7('admin:unique_fqdn_sets_paginated|json', '/unique-fqdn-sets/{@page}.json')
    config.add_route_7('admin:unique_fqdn_set:focus', '/unique-fqdn-set/{@id}')
    config.add_route_7('admin:unique_fqdn_set:focus|json', '/unique-fqdn-set/{@id}.json')
    config.add_route_7('admin:unique_fqdn_set:focus:calendar|json', '/unique-fqdn-set/{@id}/calendar.json')
