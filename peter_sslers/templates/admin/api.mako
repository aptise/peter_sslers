...
api_docs_other = {
    'account-key': [
        ...
        {'endpoint': '/account-key/{ID}/authenticate.json',
         'about': """authenticate the key against the provider's new-reg endpoint""",
         'POST': True,
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ["curl http://127.0.0.1:7201/.well-known/admin/account-key/1/authenticate.json",
                      "curl -X POST http://127.0.0.1:7201/.well-known/admin/account-key/1/authenticate.json"
                      ],
         },
