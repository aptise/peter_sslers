...
def create__SslCertificateRequest(
    ...
    if certificate_request_type_id == models.SslCertificateRequestType.ACME_FLOW:
        ...
        dbDomainObjects = [libdb.getcreate.getcreate__SslDomain__by_domainName(ctx, _domain_name)[0]
                           for _domain_name in domain_names]
        (dbUniqueFqdnSet,
         is_created_fqdn
         ) = libdb.getcreate.getcreate__SslUniqueFQDNSet__by_domainObjects(ctx, dbDomainObjects)
    ...
    try:
        ...
        # getcreate__SslDomain__by_domainName returns a tuple of (domainObject, is_created)
        dbDomainObjects = {_domain_name: libdb.getcreate.getcreate__SslDomain__by_domainName(ctx, _domain_name)[0]
                           for _domain_name in domain_names
                           }
        (dbUniqueFqdnSet,
         is_created_fqdn
         ) = libdb.getcreate.getcreate__SslUniqueFQDNSet__by_domainObjects(ctx, dbDomainObjects.values())
...
def create__SslServerCertificate(
    ...
    (dbCACertificate,
     _is_created_cert
     ) = libdb.getcreate.getcreate__SslCaCertificate__by_pem_text(ctx, chained_pem, chain_name)
    ...
    try:
        ...
        (dbUniqueFqdnSet,
         is_created_fqdn
         ) = libdb.getcreate.getcreate__SslUniqueFQDNSet__by_domainObjects(ctx, dbDomains)
...
def create__SslPrivateKey__autogenerated(ctx):
    ...
    dbPrivateKey, _is_created = libdb.getcreate.getcreate__SslPrivateKey__by_pem_text(
        ctx,
        key_pem,
