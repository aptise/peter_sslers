...
def getcreate__SslCaCertificate__by_pem_text(
    ...
    if not dbCACertificate:
        ...
        try:
            ...
            event_payload_dict = utils.new_event_payload_dict()
            dbOperationsEvent = log__SslOperationsEvent(ctx,
                                                        models.SslOperationsEventType.from_string('ca_certificate__insert'),
                                                        )
            ...
            _log_object_event(ctx,
                              dbOperationsEvent=dbOperationsEvent,
                              event_status_id=models.SslOperationsObjectEventStatus.from_string('ca_certificate__insert'),
...
def getcreate__SslDomain__by_domainName(
    ...
    if not dbDomain:
        event_payload_dict = utils.new_event_payload_dict()
        dbOperationsEvent = log__SslOperationsEvent(ctx,
                                                    models.SslOperationsEventType.from_string('domain__insert'),
                                                    )
        ...
        _log_object_event(ctx,
                          dbOperationsEvent=dbOperationsEvent,
                          event_status_id=models.SslOperationsObjectEventStatus.from_string('domain__insert'),
                          dbDomain=dbDomain,
                          )
...
def getcreate__SslPrivateKey__by_pem_text(
    ...
    key_pem_md5 = utils.md5_text(key_pem)
    is_created = False
    dbPrivateKey = ctx.dbSession.query(models.SslPrivateKey)\
        .filter(models.SslPrivateKey.key_pem_md5 == key_pem_md5,
    ...
    if not dbPrivateKey:
        ...
        event_payload_dict = utils.new_event_payload_dict()
        _event_type_id = models.SslOperationsEventType.from_string('private_key__insert')
        if is_autogenerated_key:
            _event_type_id = models.SslOperationsEventType.from_string('private_key__insert_autogenerated')
        dbOperationsEvent = log__SslOperationsEvent(ctx,
                                                    _event_type_id,
                                                    )
        ...
        _log_object_event(ctx,
                          dbOperationsEvent=dbOperationsEvent,
                          event_status_id=models.SslOperationsObjectEventStatus.from_string('private_key__insert'),
                          dbPrivateKey=dbPrivateKey,
                          )
...
def getcreate__SslServerCertificate__by_pem_text(
    ...
    dbServerCertificate = ctx.dbSession.query(models.SslServerCertificate)\
        .filter(models.SslServerCertificate.cert_pem_md5 == cert_pem_md5,
...
def getcreate__SslUniqueFQDNSet__by_domainObjects(
    ...
    dbUniqueFQDNSet = ctx.dbSession.query(models.SslUniqueFQDNSet)\
    ...
    if not dbUniqueFQDNSet:
        event_payload_dict = utils.new_event_payload_dict()
        dbOperationsEvent = log__SslOperationsEvent(ctx,
                                                    models.SslOperationsEventType.from_string('unqiue_fqdn__insert'),
                                                    )
        ...
        _log_object_event(ctx,
                          dbOperationsEvent=dbOperationsEvent,
                          event_status_id=models.SslOperationsObjectEventStatus.from_string('unqiue_fqdn__insert'),
