...
def queue_domains__process(
    ...
    if privateKey is None:
        privateKey = get__LetsencryptPrivateKey__current_week(dbSession)
        if not privateKey:
            privateKey = create__LetsencryptPrivateKey__new(dbSession, is_autogenerated_key)
            
    if False:
        result = create__CertificateRequest__FULL(
                        DBSession,
                        domain_names,
