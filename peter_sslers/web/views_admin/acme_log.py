...
class ViewAdmin_AcmeEventLog(Handler):
    ...
    def acme_event_log(self):
        ...
        items_paged = lib_db.get.get__SslAcmeEventLogs__paginated(
            self.request.api_context, limit=items_per_page, offset=offset
        )
        return {"project": "peter_sslers", "SslAcmeEventLogs": items_paged}

    def _acme_event_log_focus(self):
        dbSslAcmeEventLog = lib_db.get.get__SslAcmeEventLog__by_id(
    ...
    def acme_event_log_focus(self):
        ...
        return {"project": "peter_sslers", "SslAcmeEventLog": item}
