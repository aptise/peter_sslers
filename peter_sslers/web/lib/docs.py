...
json_capable = {
    ...
    "/acme-account-key/{ID}/parse.json": {
    ...
    "/acme-account-key/{ID}/key.pem.txt": {
    ...
    "/acme-account-key/upload.json": {
        ...
        "args": None,
        "examples": [
            "curl --form 'account_key_file_pem=@key.pem' --form 'acme_account_provider_id=1' {ADMIN_PREFIX}/acme-account-key/upload.json",
