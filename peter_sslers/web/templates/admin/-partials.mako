...
<%def name="formgroup__AcmeAccountKey_selector__advanced(dbAcmeAccountKeyReuse=None, allow_no_key=False)">
    ...
    <div class="form-horizontal">
        ...
        % if AcmeAccountKey_GlobalDefault:
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="account_key_option" id="account_key_option-account_key_global_default" value="account_key_default"${checked}/>
...
<%def name="formgroup__PrivateKey_selector__advanced(show_text=None, dbPrivateKeyReuse=None, option_account_key_default=None, option_generate_new=None)">
    ...
    <div class="form-horizontal">
        ...
        % if PrivateKey_GlobalDefault:
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="private_key_option" id="private_key_option-private_key_global_default" value="private_key_global_default"${checked}/>
