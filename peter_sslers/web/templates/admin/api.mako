...
api_docs_other = {
    ...
    'certificate': [
        ...
        {'endpoint': '/server-certificate/{ID}/renew/queue.json',
         'about': """renewal - quick""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/server-certificate/1/renew/queue.json",
         },
    ...
    'unique-fqdn-set': [
        ...
        {'endpoint': '/unique-fqdn-set/{ID}/renew/queue.json',
         'about': """renewal - quick""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/unique-fqdn-set/1/renew/queue.json",
         },
    ]
}
%>
