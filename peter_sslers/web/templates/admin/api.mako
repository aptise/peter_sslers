...
api_docs_other = {
    'acme-account-key': [
        {'endpoint': '/acme-account-keys.json',
         ...
         'GET': True,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-keys.json",
         },
        {'endpoint': '/acme-account-keys/{PAGE}.json',
         'about': """list account keys, paginated""",
         'POST': True,
         'GET': True,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-keys/1.json",
         },
        {'endpoint': '/acme-account-key/{ID}.json',
         'about': """acme-account-key record""",
         'POST': True,
         'GET': True,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1.json",
         },
        {'endpoint': '/acme-account-key/{ID}/config.json',
         'about': """config info for an account key""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1/config.json",
         },
        {'endpoint': '/acme-account-key/{ID}/parse.json',
         'about': """parse an account key""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1/parse.json",
         },
        {'endpoint': '/acme-account-key/{ID}/key.key',
         'about': """key as der""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1/key.key",
         },
        {'endpoint': '/acme-account-key/{ID}/key.pem',
         'about': """key as pem""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1/key.pem",
         },
        {'endpoint': '/acme-account-key/{ID}/key.pem.txt',
         'about': """key as pem/txt""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/acme-account-key/1/key.pem.txt",
         },
        {'endpoint': '/acme-account-key/upload.json',
         'about': """Upload an account-key""",
         'POST': True,
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ["curl --form 'account_key_file_pem=@key.pem' --form 'acme_account_provider_id=1' {ADMIN_PREFIX}/acme-account-key/upload.json",
        ...
        {'endpoint': '/acme-account-key/{ID}/authenticate.json',
         ...
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ["curl http://127.0.0.1:7201/.well-known/admin/acme-account-key/1/authenticate.json",
                      "curl -X POST http://127.0.0.1:7201/.well-known/admin/acme-account-key/1/authenticate.json"
                      ],
         },
        {'endpoint': '/acme-account-key/{ID}/mark.json',
         'about': """mark the key""",
         'POST': True,
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
    ...
    'certificate': [
        ...
        {'endpoint': '/server-certificate/{ID}/renew/queue.json : TODO REMOVE',
         'about': """renewal - quick""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/server-certificate/1/renew/queue.json : TODO REMOVE",
         },
        ...
        {'endpoint': '/server-certificate/{ID}/mark.json',
         ...
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ["curl {ADMIN_PREFIX}/server-certificate/1/mark.json",
        ...
        {'endpoint': '/server-certificate/upload.json',
         ...
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ["curl http://127.0.0.1:7201/.well-known/admin/server-certificate/upload.json",
    ...
    'queue-certificate': [
        ...
        {'endpoint': '/queue-certificate/{ID}/mark.json',
         ...
         'GET': None,
         'args': """This route is self-documenting on GET requests""",
         'examples': ['curl {ADMIN_PREFIX}/queue-certificate/1/mark.json',
    ...
    'unique-fqdn-set': [
        ...
        {'endpoint': '/unique-fqdn-set/{ID}/renew/queue.json : TODO REMOVE',
         'about': """renewal - quick""",
         'POST': True,
         'GET': None,
         'args': "",
         'example': "curl {ADMIN_PREFIX}/unique-fqdn-set/1/renew/queue.json : TODO REMOVE",
         },
    ]
}
%>
