...
class SslOperationsEventType(_mixin_mapping):
    """
    This object used to store constants
    """
    _mapping = {
        2: 'operations__update_recents',
        5: 'operations__redis_prime',
        6: 'operations__nginx_cache_expire',
        7: 'operations__nginx_cache_flush',

        101: 'letsencrypt_account_key__insert',
        102: 'letsencrypt_account_key__authenticate',
        103: 'letsencrypt_account_key__mark',

        200: 'ca_certificate__probe',
        201: 'ca_certificate__insert',
        202: 'ca_certificate__upload_bundle',

        301: 'private_key__insert',
        302: 'private_key__mark',
        303: 'private_key__revoke',
        304: 'private_key__insert_autogenerated',
        ...
        602: 'certificate_request__new',
        603: 'certificate_request__new__flow',
        604: 'certificate_request__new__automated',
        605: 'certificate_request__do__automated',
