...
<%block name="content_main">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>${LetsencryptAccountKey.timestamp_first_seen}</td>
        </tr>
        <tr>
            <th>key_pem_md5</th>
        ...
        <tr>
            ...
            <td>
                ${admin_partials.table_certificate_requests__list(LetsencryptAccountKey.certificate_requests, show_domains=True)}
            </td>
        </tr>
    </table>
